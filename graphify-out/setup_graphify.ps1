...
if ($GRAPHIFY_PYTHON) {
    ...
    "f:\ProcureIQ-v0\procureIQ-v0" | Out-File -FilePath "graphify-out\.graphify_root" -Encoding utf8 -NoNewline
    Write-Host "SUCCESS: Graphify python saved: $GRAPHIFY_PYTHON"
} else {
